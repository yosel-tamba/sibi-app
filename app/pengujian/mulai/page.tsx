                        ...
                        try {
                            ...
                            if (response.ok) {
                                ...
                                if (endsWithNumberMatch) {
                                    ...
                                    // Cek apakah suku kata yang dideteksi sesuai dengan kata target
                                    if (wordBase.toLowerCase() === targetWord.toLowerCase()) {
                                        ...
                                        // Jika kedua suku kata sudah terdeteksi
                                        if (currentV1 && currentV2) {
                                            detectedWord = targetWord;
                                        }
                                    }
                                } else {
                                ...
                                // Cek kesesuaian prediksi penuh dengan kata target
                                if (
                                    detectedWord &&
                                    targetWord &&
